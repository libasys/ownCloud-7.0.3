...
class HelperController extends Controller {
	...
	public function generatePinRow($row) {
			...
			$row['userdisplayname']=\OC_User::getDisplayName($row['user_id']);
   ...
   public function getPinWallBackground($id){
	...
	public function  relative_modified_date($timestamp) {
		...
		elseif($timeDiff < 3600) { return $l->n('%n minute ago', '%n minutes ago', $diffMinutes); }
		elseif($timeDiff < 86400) { return $l->n( '%n hour ago', '%n hours ago', $diffHours); }
		elseif($timeDiff < 86400) { return $l->t('today'); }
		elseif($timeDiff < 172800) { return $l->t('yesterday'); }
		elseif($timeDiff < 2678400) { return $l->n('%n day ago', '%n days ago', $diffDays); }
		elseif($timeDiff < 5184000) { return $l->t('last month'); }
		elseif($timeDiff < 31556926) { return $l->n( '%n month ago', '%n months ago', $diffMonths); }
		elseif($timeDiff < 63113852) { return $l->t('last year'); }
