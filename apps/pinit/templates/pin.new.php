<div id="new-pin">
  ...
  <textarea id="imgsrc" name="imgsrc" style="display:none;"></textarea>
      ...
      <span style="text-align:left;float:left;padding-left:5px; width:54%;padding-top:10px;border-right:1px solid #f4f4f4;">
       ...
       <br style="clear:both;">   
	 	<input type="text" placeholder="<?php p($l -> t("Name")); ?>" value="" maxlength="300" id="pname"  name="pname" />
	 	<textarea style="width:300px;min-height:100px;" placeholder="<?php p($l -> t("Description")); ?>" id="pdescr"  name="pdescr"></textarea>
